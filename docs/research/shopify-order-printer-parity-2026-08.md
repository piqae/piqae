...
| Templates               | Customizable Liquid/code templates, compatible with Shopify Order Printer templates; logo/color/font/branding/fields                                                                    | Word-like structured editor produces `printpacket/v1`; the bounded Liquid profile compiles to the same semantic tree. Import reports exact unsupported constructs and never claims silent 100% conversion                                             | P0/P1             |
