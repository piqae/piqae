...
description: Add and validate append-only Spool PostgreSQL migrations with mandatory tenant isolation and upgrade compatibility. Use whenever database schema or persistent projections change.
---
...
4. Use `.spool-test-fixtures/postgres-migration` with Compose PostgreSQL.
