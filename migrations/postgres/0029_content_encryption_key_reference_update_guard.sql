DROP TRIGGER encrypted_job_key_references_lifecycle_guard
    ON encrypted_job_key_references;

CREATE OR REPLACE FUNCTION guard_encrypted_job_key_reference() RETURNS trigger
LANGUAGE plpgsql
...
BEFORE INSERT OR UPDATE ON encrypted_job_key_references
