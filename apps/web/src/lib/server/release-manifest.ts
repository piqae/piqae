...
const builtInManifest: ReleaseManifest = {
  ...
  updatedAt: null,
  releasesUrl: 'https://github.com/C4CoffeeCo/spool/releases',
  repositoryUrl: 'https://github.com/C4CoffeeCo/spool',
  artifacts: [
    {
      id: 'windows-x86_64',
      platform: 'windows',
      ...
      downloadUrl: null,
      releaseUrl: 'https://github.com/C4CoffeeCo/spool/releases',
      sha256: null,
      checksumUrl: null,
