...
const builtInManifest: ReleaseManifest = {
  ...
  updatedAt: null,
  releasesUrl: 'https://github.com/C4CoffeeCo/piqae/releases',
  repositoryUrl: 'https://github.com/C4CoffeeCo/piqae',
  artifacts: [
    {
      id: 'windows-x86_64',
      platform: 'windows',
      ...
      downloadUrl: null,
      releaseUrl: 'https://github.com/C4CoffeeCo/piqae/releases',
      sha256: null,
      checksumUrl: null,
