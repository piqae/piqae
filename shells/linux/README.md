...
Desktop environments without StatusNotifier support run Piqae headlessly and
use `piqaectl` or the loopback UI. The package is advertised as Preview until
