...
import XCTest
@testable import PiqaeProfileHost
...
final class MacPrintProfileSerializerTests: XCTestCase {
    ...
    func testCaptureAndRestorePrintCoreRepresentations() throws {
        ...
        source.printSettings[NSPrintInfo.SettingKey("com_piqae_test")] = "preserved"
        ...
        XCTAssertEqual(restored.printSettings[NSPrintInfo.SettingKey("com_piqae_test")] as? String, "preserved")
